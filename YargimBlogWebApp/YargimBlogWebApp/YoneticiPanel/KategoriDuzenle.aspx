<%@ Page Title="" Language="C#" MasterPageFile="~/YoneticiPanel/YoneticiMaster.Master" AutoEventWireup="true" CodeBehind="KategoriDuzenle.aspx.cs" Inherits="YargimBlogWebApp.YoneticiPanel.KategoriDuzenle" %>
    ...
    <div class="formTasiyici">
        ...
        <div class="formIcerik">
            ...
            <asp:Panel ID="pnl_basarisiz" runat="server" CssClass="basarisizPanel" Visible="false">
                ...
                <asp:Label ID="lbl_mesaj" runat="server" CssClass="metinKutu">Kategori Düzenlemesi Başarısız</asp:Label>
            </asp:Panel>
            <div class="satir">

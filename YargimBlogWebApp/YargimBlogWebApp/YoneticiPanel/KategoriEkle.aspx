<%@ Page Title="" Language="C#" MasterPageFile="~/YoneticiPanel/YoneticiMaster.Master" AutoEventWireup="true" CodeBehind="KategoriEkle.aspx.cs" Inherits="YargimBlogWebApp.YoneticiPanel.KategoriEkle" %>
    ...
    <div class="formTasiyici">
        ...
        <div class="formIcerik">
            ...
            <asp:Panel ID="pnl_basarisiz" runat="server" CssClass="basarisizPanel" Visible="false">
                ...
                <asp:Label ID="lbl_mesaj" runat="server">Kategori Eklenemedi!</asp:Label>
            </asp:Panel>
            <div class="satir">
